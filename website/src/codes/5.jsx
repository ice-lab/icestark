  ...
  return (
    <>
      ...
      <p>
        ...
        也就是说，icestark 会默认通过 <a href='https://developer.mozilla.org/en-US/docs/Web/HTML/Element/script'>Script 元素</a> 将微应用的脚本资源插入到 <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/head">Head 元素</a>当中。
      </p>
      <p>错误表达的含义是：<b>脚本资源 {args[0]} 加载失败了</b>。</p>
      <p>需要注意的是：脚本执行错误并不在本错误的包含范围内。</p>
      <br />
      <h2>解决办法</h2>
